...
<body>
		...
		<p>Your total price is: ${total}</p>
			...
			<a href="Store"><button type="submit" class="btn btn-default" style="margin-left: 6%">Go to store</button></a>
			<br>
			</br>
		...
		<input type="submit" name="add" value="Complete Transaction" / style="margin-left: 5%">	
	</form>
